...
class _SetPasswordState extends State<SetPassword> with OuiSyncAppLogger {
  ...
  @override
  void initState() {
    _configureInputs(_generatePassword);
  ...
  void _configureInputs(bool generatePassword,
      {bool preservePassword = false}) {
    if (!preservePassword) {
      // Generate password or clean controllers if manual was selected by the user
      final newPassword = _generatePassword ? _generateRandomPassword() : '';
  ...
  String _generateRandomPassword() {
    ...
    if (kDebugMode) {
      loggy.app(
          'Autogenerated password for repo ${widget.repositoryName}: $autogeneratedPassword');
    }
