...
class Dimensions {
  ...
  static const EdgeInsets paddingRepositoryPicker = EdgeInsets.symmetric(vertical: 0.0, horizontal: 2.0);
  ...
  static const EdgeInsets paddingActionBoxRight = EdgeInsets.only(right: 5.0, bottom: 10.0);
