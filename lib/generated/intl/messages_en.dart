...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(totals) => "Copy selection here:\n\n\t\t${totals}";

  static String m2(totals) => "Delete selection:\n\n\t\t${totals}";

  static String m3(path) => "File downloaded to ${path}";

  static String m4(name) => "${name} - downloading canceled";

  static String m5(name) => "${name} - download failed";

  static String m6(entry) => "${entry} already exists.";

  static String m7(name) => "Error creating folder ${name}";
  ...
  static String m10(dokanUrl) => "Dokan is missing.${dokanUrl}";

  static String m11(name) => "Initialization of the repository ${name} failed";

  static String m12(path) => "${path} is not empty";

  static String m13(name) => "Failed to import repository ${name}";

  static String m14(name) => "Failed to create repository ${name}";
  ...
  static String m17(name) => "File deleted successfully: ${name}";

  static String m18(name) => "File renamed as ${name}";

  static String m19(name) => "Folder deleted successfully: ${name}";

  static String m20(name) => "Folder renamed as ${name}";

  static String m21(number) =>
      "Do you want to lock all open repositories?\n\n(${number} open)";

  static String m22(totals) => "Move selection here:\n\n\t\t${totals}";

  static String m23(path) => "from ${path}";

  static String m24(name) => "Error creating file ${name}";

  static String m25(name) => "Error opening file ${name}";

  static String m26(path) => "Previewing file ${path} failed";

  static String m27(name) => "We could not delete the repository \"${name}\"";

  static String m28(name) =>
      "We could not find the repository \"${name}\" at the usual location";

  static String m29(access) => "Access mode granted: ${access}";

  static String m30(name) =>
      "This repository already exists in the app under the name \"${name}\".";

  static String m31(name) => "Repository ${name} deleted";

  static String m32(name) => "Repository renamed as ${name}";

  static String m33(name) => "Suggested: ${name}\n(tap here to use this name)";

  static String m34(totals) => "Save selection:\n\n\t\t${totals}";

  static String m35(name) => "Sort by: ${name}";

  static String m36(access) => "Unlocked as a ${access} replica";

  static String m37(name) => "Enter password to unlock \"${name}\"";

  static String m38(name) => "${name} writing canceled";

  static String m39(name) => "${name} - writing failed";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "actionDeleteFolder": MessageLookupByLibrary.simpleMessage("Delete folder"),
    ...
    "actionIDontAgree": MessageLookupByLibrary.simpleMessage("I don’t agree"),
    ...
    "actionNewRepo": MessageLookupByLibrary.simpleMessage("Create repository"),
    ...
    "actionPreviewFile": MessageLookupByLibrary.simpleMessage("Preview file"),
    ...
    "actionSaveChanges": MessageLookupByLibrary.simpleMessage("Save changes"),
    ...
    "labelDownloadedTo": MessageLookupByLibrary.simpleMessage("Downloaded to:"),
    ...
    "labelSyncStatus": MessageLookupByLibrary.simpleMessage("Sync Status: "),
    ...
    "menuItemRepository": MessageLookupByLibrary.simpleMessage("Repository"),
    ...
    "messageAuthenticate": MessageLookupByLibrary.simpleMessage("Authenticate"),
    ...
    "messageBackgroundNotification": MessageLookupByLibrary.simpleMessage(
      "Ouisync is running",
    ),
    ...
    "messageEntryTypeDefault": MessageLookupByLibrary.simpleMessage("An entry"),
    "messageEntryTypeFile": MessageLookupByLibrary.simpleMessage("A file"),
    "messageEntryTypeFolder": MessageLookupByLibrary.simpleMessage("A folder"),
    ...
    "messageErrorDefaultShort": MessageLookupByLibrary.simpleMessage("Failed."),
    ...
    "messageFileRenamed": m18,
    "messageFiles": MessageLookupByLibrary.simpleMessage("files"),
    "messageFolderDeleted": m19,
    "messageFolderName": MessageLookupByLibrary.simpleMessage("Folder name"),
    "messageFolderRenamed": m20,
    ...
    "messageLoadingDefault": MessageLookupByLibrary.simpleMessage("Loading…"),
    ...
    "messagePeerRemoved": MessageLookupByLibrary.simpleMessage("Peer removed"),
    "messagePermissionRequired": MessageLookupByLibrary.simpleMessage(
      "This permission is required",
    ),
    "messagePleaseAuthenticate": MessageLookupByLibrary.simpleMessage(
      "Please authenticate",
    ),
    ...
    "messageRenameFile": MessageLookupByLibrary.simpleMessage("Rename file"),
    ...
    "repoResetAccessTypeInfoRead": MessageLookupByLibrary.simpleMessage("Read"),
    "repoResetAccessTypeInfoWrite": MessageLookupByLibrary.simpleMessage(
      "Write",
    ),
    "repoResetAccessTypeLabel": MessageLookupByLibrary.simpleMessage(
    ...
    "repoResetActionInfoLabel": MessageLookupByLibrary.simpleMessage(
    ...
    "repoResetAuthInfoLabel": MessageLookupByLibrary.simpleMessage(
      "Authentication method",
    ),
    "repoResetAuthInfoLocked": MessageLookupByLibrary.simpleMessage(
      "Locked behind a local password.",
    ),
    "repoResetAuthInfoPasswordIsStored": MessageLookupByLibrary.simpleMessage(
    ...
    "repoResetConfirmUpdateTitle": MessageLookupByLibrary.simpleMessage(
      "Please confirm",
    ),
    "repoResetRepoNameLabel": MessageLookupByLibrary.simpleMessage(
      "Repository name",
    ),
    "repoResetTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "repoResetTokenInvalid": MessageLookupByLibrary.simpleMessage("Invalid"),
    "repoResetTokenInvalidInfo": MessageLookupByLibrary.simpleMessage(
    ...
    "statusUnspecified": MessageLookupByLibrary.simpleMessage("Unspecified"),
    "titleAbout": MessageLookupByLibrary.simpleMessage("About"),
    "titleAddFile": MessageLookupByLibrary.simpleMessage("Add file to Ouisync"),
    ...
    "titleDeleteEntries": MessageLookupByLibrary.simpleMessage("Delete"),
    "titleDeleteFile": MessageLookupByLibrary.simpleMessage("Delete file"),
    "titleDeleteFolder": MessageLookupByLibrary.simpleMessage("Delete folder"),
    ...
    "titleFileDetails": MessageLookupByLibrary.simpleMessage("File details"),
    ...
    "titleMoveEntries": MessageLookupByLibrary.simpleMessage("Move"),
    "titleMovingEntry": MessageLookupByLibrary.simpleMessage("Moving entry"),
    ...
    "titleSaveChanges": MessageLookupByLibrary.simpleMessage("Save changes"),
    "titleSaveEntriesToDevice": MessageLookupByLibrary.simpleMessage(
      "Save to device",
    ),
    ...
    "titleSendFeedback": MessageLookupByLibrary.simpleMessage("Send feedback"),
    ...
    "titleWeAreEq": MessageLookupByLibrary.simpleMessage("We are eQualit.ie"),
