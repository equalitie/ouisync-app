...
public class NonReplicatedFileProvider: NSFileProviderExtension {
    ...
    override public func persistentIdentifierForItem(at url: URL) -> NSFileProviderItemIdentifier? {
        nil
    }
    ...
    /** Should return the URL corresponding to a specific identifier. Fail if it's not
     ...
     corresponding to the same file. By default, this returns the path relative to
     the path returned by documentStorageURL. */
    override public func urlForItem(withPersistentIdentifier identifier: NSFileProviderItemIdentifier) -> URL? {
        nil
    }

    @available(iOS 11.0, *)
    override public func item(for identifier: NSFileProviderItemIdentifier) throws -> NSFileProviderItem {
        return try super.item(for: identifier)
    }
    ...
    public override func enumerator(for containerItemIdentifier: NSFileProviderItemIdentifier) throws -> any NSFileProviderEnumerator {
        Enumerator()
    }

    /** Called at some point after the file has changed; the provider may then trigger
     an upload. */
    override public func itemChanged(at url: URL) {
    ...
    /** This method is called when a placeholder URL should be provided for the item at
     ...
     handler. */
    override public func providePlaceholder(at url: URL) async throws {
    ...
    override public func startProvidingItem(at url: URL) async throws {
    ...
    override public func stopProvidingItem(at url: URL) {
    ...
    override public func createDirectory(withName name: String,
                                         inParentItemIdentifier parent: NSFileProviderItemIdentifier
    ...
    override public func deleteItem(withIdentifier id: NSFileProviderItemIdentifier) async throws {
    ...
    override public func importDocument(at fileURL: URL,
     ...
     */
    override public func renameItem(withIdentifier id: NSFileProviderItemIdentifier,
                                    toName: String) async throws -> NSFileProviderItem {
    ...
    override public func reparentItem(withIdentifier id: NSFileProviderItemIdentifier,
                                      toParentItemWithIdentifier parent:
                                      NSFileProviderItemIdentifier, newName: String?
    ) async throws -> NSFileProviderItem {
    ...
    override public func setFavoriteRank(_ favoriteRank: NSNumber?,
                                         forItemIdentifier id: NSFileProviderItemIdentifier
    ) async throws -> NSFileProviderItem {
    ...
    override public func setLastUsedDate(_ lastUsedDate: Date?,
                                         forItemIdentifier id: NSFileProviderItemIdentifier
    ) async throws -> NSFileProviderItem {
     ...
     */
    override public func setTagData(_ tagData: Data?,
                                    forItemIdentifier id: NSFileProviderItemIdentifier
    ) async throws -> NSFileProviderItem {
    ...
    override public func trashItem(withIdentifier id: NSFileProviderItemIdentifier
    ) async throws -> NSFileProviderItem {
    ...
    override public func untrashItem(withIdentifier id: NSFileProviderItemIdentifier,
                                     toParentItemIdentifier parent: NSFileProviderItemIdentifier?
    ) async throws -> NSFileProviderItem {
    ...
    /*
    override public func fetchThumbnails(
    ...
    override public func supportedServiceSources(for id: NSFileProviderItemIdentifier
