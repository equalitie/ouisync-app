...
#define MyAppName "Ouisync"
#define MyAppVersion "0.7.2"
#define MyAppPublisher "eQualitie"
#define MyAppURL "https://ouisync.net"
#define MyAppExeName "ouisync_app.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{47AB3BBF-2DDA-44D2-B462-CA0729AF6F31}
AppName={#MyAppName}
...
OutputBaseFilename=ouisync-installer
OutputDir={#SourcePath}..\build\windows\runner\Release
SetupIconFile={#SourcePath}..\assets\favicon.ico
Compression=lzma
...
Source: "{#SourcePath}..\build\windows\runner\Release\connectivity_plus_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "{#SourcePath}..\build\windows\runner\Release\Webview2Loader.dll"; DestDir: "{app}"; Flags: ignoreversion
